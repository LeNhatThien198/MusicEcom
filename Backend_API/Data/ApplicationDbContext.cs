    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MasterTrack>(entity =>
            {
                ...
                entity.HasOne(t => t.MasterRelease).WithMany(m => m.Tracks).HasForeignKey(t => t.MasterReleaseId).OnDelete(DeleteBehavior.Cascade);
            });
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                entity.Property(o => o.PaymentStatus).HasDefaultValue(PaymentStatus.Unpaid);
            ...
            modelBuilder.Entity<RedemptionCode>(entity =>
            {
                ...
                entity.Property(rc => rc.Status).HasDefaultValue(RedemptionStatus.Active);
            ...
            modelBuilder.Entity<SupportTicket>(entity =>
            {
                ...
                entity.Property(st => st.Status).HasDefaultValue(TicketStatus.Open);
            ...
            modelBuilder.Entity<TicketMessage>(entity =>
            {
                ...
                entity.HasOne(tm => tm.SupportTicket).WithMany(st => st.Messages).HasForeignKey(tm => tm.SupportTicketId).OnDelete(DeleteBehavior.Restrict);
